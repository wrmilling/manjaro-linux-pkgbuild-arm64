...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
	...
	'1019-add-h6-hdmi-audio-driver.patch'           			   # H6 HDMI Audio Driver
	'1020-add-h6-hdmi-audio-dtsi.patch'					   # H6 HDMI Audio DTSI
	'1021-add-h6-hdmi-audio-driver-dts.patch'				   # H6 HDMI Audio DTS	
	'1022-add-opi3-lts-dts.patch'						   # OPI 3 LTS DTS
...
md5sums=('2d9d725a716d27c82ea31d2b4e802158'
         ...
         '38a98d96bd76ab22a4c5ecb34cec0204'
