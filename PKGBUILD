...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
        ...
        '1020-arm64-dts-allwinner-add-OrangePi-3-LTS.patch'                        # Orange Pi 3 LTS
        '1021-arm64-dts-meson-radxa-zero-add-support-for-the-usb-t.patch'          # Radxa Zero
        '1022-arm64-dts-rockchip-add-OrangePi-4-LTS.patch'                         # Orange Pi 4 LTS
        ...
        '60-linux.hook'
        '90-linux.hook')
md5sums=('a8db20740f7398af70543a645a4cd7ae'
         ...
         '9aa78625895ab5ceaea046ae4ef6a3ea'
         ...
         'c76c4af8e85ddda3214d793b32651def'
