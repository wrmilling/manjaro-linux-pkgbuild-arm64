...
md5sums=('e6680ce7c989a3efe58b51e3f3f0bf93'
         '69c109b23427678fcf28dc4f8ae83129'
         '19d1b1610baad27d412cd1add53a879b'
...
prepare() {
  ...
  patch -Np1 -i "${srcdir}/1005-nuumio-panfrost-Silence-Panfrost-gem-shrinker-loggin.patch"          # Panfrost
  patch -Np1 -i "${srcdir}/1006-arm64-dts-rockchip-Add-Firefly-Station-p1-support.patch"             # Firelfy Station P1
  patch -Np1 -i "${srcdir}/1007-ayufan-drm-rockchip-add-support-for-modeline-32MHz-e.patch"          # DP Alt mode
  patch -Np1 -i "${srcdir}/1008-rk3399-rp64-pcie-Reimplement-rockchip-PCIe-bus-scan-delay.patch"     # RockPro64
  patch -Np1 -i "${srcdir}/1009-drm-meson-add-YUV422-output-support.patch"                           # G12B
  ...
  patch -Np1 -i "${srcdir}/2005-staging-add-rtl8723cs-driver.patch"                                  # Wifi
