...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
        ...
        '2004-staging-add-rtl8723cs-driver.patch'                                  # Realtek WiFi;  Not upstreamable
        ...
        '3027-phy-rockchip-inno-usb2-Only-sync-state-when-we-own-e.patch'          # Quartz64 and associated patches that are still being upstreamed: END
        'config'
        'linux.preset'
        '60-linux.hook'
        '90-linux.hook')
md5sums=('9d0eec53c479f141f30ae9845b115889'
         ...
         '427faa0d2b92089a50935674ab070a72'
         ...
         '4c42a5767a43da49e6f66ea6089578d3'
