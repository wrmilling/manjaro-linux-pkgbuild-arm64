...
source=("http://www.kernel.org/pub/linux/kernel/v6.x/${_srcname}.tar.xz"
        ...
        '3014-phy-rockchip-inno-usb2-Return-zero-after-otg-sync.patch'             # From list: https://patchwork.kernel.org/project/linux-rockchip/patch/20220824122543.174730-1-pgwipeout@gmail.com/ (applied in linux-next)
        ...
        '60-linux.hook'
        '90-linux.hook')
md5sums=('514d7aafe8964474b14f8fe6c69e6895'
         ...
         '1d8c900d58e07d57d007c176647c03a0'
