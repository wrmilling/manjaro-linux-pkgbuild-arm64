...
_newversion=false
_minorpatch=false    # Also update the lists of sources and hashes
...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
        ...
        '1009-drm-meson-add-YUV422-output-support.patch'                           # Disabled, waiting for proper 5.17-based patch
        ...
        '2008-brcmfmac-USB-probing-provides-no-board-type.patch'                   # Will be submitted upstream by the author
        '2009-dts-rockchip-Adapt-and-adopt-Type-C-support-from-Pin.patch'          # Not upstreamable
        '3170-arm64-dts-rk3399-pinebook-pro-Fix-USB-PD-charging.patch'             # Third set of patches: START
        '3172-arm64-dts-rk3399-pinebook-pro-Improve-Type-C-support.patch'          # All patches in the third set are from https://xff.cz/kernels/5.17/patches/
        '3174-arm64-dts-rk3399-pinebook-pro-Remove-redundant-pinct.patch'          # See the prepare() function below for more details
...
md5sums=('07321a70a48d062cebd0358132f11771'
         ...
         'e44754e1daa5ffc7f934c0020d5ac662'
         ...
         '2985c1a0639bb18514d18d2c1af71b33'
...
prepare() {
  ...
  patch -Np1 -i "${srcdir}/1010-arm64-dts-amlogic-add-initial-Beelink-GT1-Ultimate-dev.patch"        # Beelink
  ...
  patch -Np1 -i "${srcdir}/2008-brcmfmac-USB-probing-provides-no-board-type.patch"                   # Bluetooth
  patch -Np1 -i "${srcdir}/2009-dts-rockchip-Adapt-and-adopt-Type-C-support-from-Pin.patch"          # DP Alt Mode
  ...
  patch -Np1 -i "${srcdir}/3170-arm64-dts-rk3399-pinebook-pro-Fix-USB-PD-charging.patch"
  patch -Np1 -i "${srcdir}/3172-arm64-dts-rk3399-pinebook-pro-Improve-Type-C-support.patch"
  patch -Np1 -i "${srcdir}/3174-arm64-dts-rk3399-pinebook-pro-Remove-redundant-pinct.patch"
  patch -Np1 -i "${srcdir}/3178-arm64-dts-rk3399-pinebook-pro-Don-t-allow-usb2-phy-d.patch"
