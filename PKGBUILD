...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
        ...
        '1019-ASOC-sun9i-hdmi-audio-Initial-implementation.patch'                  # Allwinner H6 HDMI audio
        '1020-arm64-dts-allwinner-h6-Add-hdmi-sound-card.patch'                    # Allwinner H6 HDMI audio
        '1021-arm64-dts-allwinner-h6-Enable-hdmi-sound-card-on-boards.patch'       # Allwinner H6 HDMI audio
        '1022-arm64-dts-allwinner-add-OrangePi-3-LTS.patch'                        # OrangePi 3 LTS
...
md5sums=('2d9d725a716d27c82ea31d2b4e802158'
         ...
         'a2180a254033c885b3856af25a4cc340'
