...
source=("http://www.kernel.org/pub/linux/kernel/v5.x/${_srcname}.tar.xz"
        ...
        '2010-arm64-dts-rockchip-Work-around-daughterboard-issues.patch'           # Pinebook Pro microSD;  Will be submitted upstream by the author
        ...
        '60-linux.hook'
        '90-linux.hook')
md5sums=('3080991d35e3c490f4cef781394a31bb'
         ...
         '5b8866f0cf14f7d1ca44bc5d6761af0b'
